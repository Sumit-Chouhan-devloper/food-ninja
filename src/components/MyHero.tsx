...
const MyHero = () => {
  return (
    <div className="container xl:max-w-[1100px] 3xl:max-w-[1140px] mx-auto px-3 xl:px-0">
      <h1 className="ff_Merriweather text-[#000638] font-black text-center md:text-5xl text-4xl pt-[92px]">
        The Food Ninja Blog
      </h1>
      ...
      <div className="flex items-center justify-between border border-[#DDDDDD] max-w-[430px] mx-auto rounded-[5px] py-3 md:py-[18px] sm:pl-7 md:pe-6 px-3">
        <input
