...
const MyHero = () => {
  return (
    <div
      className="container xl:max-w-[1100px] 3xl:max-w-[1140px] mx-auto px-3 xl:px-0"
      id="contact"
    >
      <h1
      ...
      <form className="flex items-center justify-between border border-[#DDDDDD] max-w-[430px] mx-auto rounded-[5px] py-3 md:py-[14px] sm:pl-7 md:pe-6 px-3 hover:shadow-lg transition-all duration-300">
        <input
          id="search"
