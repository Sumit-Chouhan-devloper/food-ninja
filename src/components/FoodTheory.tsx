...
const FoodTheory = () => {
  return (
    <div className="container xl:max-w-[800px] 3xl:max-w-[1140px] mx-auto px-3 xl:px-0 pt-[93px]">
      ...
      <p className="ff_roboto text-[#434343] font-medium leading-[160%] text-2xl sm:text-[26px] py-[30px]">
      ...
      <p className="ff_roboto text-[#434343] text-[18px] sm:text-2xl leading-[160%] pb-10">
      ...
      <div className="bg-[#F5F5F5] px-9 py-8 rounded-[7px]">
        <h3 className="ff_Merriweather text-black text-[22px] font-bold sm:text-2xl leading-[160%] pb-4">
          In this article
        </h3>
        <p className="ff_Merriweather text-#303030 text-base sm:text-lg leading-[160%]">1. 
        <span className="relative before:absolute before:bg-[#303030] before:h-[1px] before:w-full before:left-[1%] before:content-[''] before:bottom-[2px]"> How to travel without spending a dime</span>

        </p>
        <p className="ff_Merriweather text-#303030 text-base sm:text-lg leading-[160%] py-4">
          2. 
          <span className="relative before:absolute before:bg-[#303030] before:h-[1px] before:w-full before:left-[1%] before:content-[''] before:bottom-[2px] my-4"> Get the most out of your credit card reward points</span>

        </p>
        <p className="ff_Merriweather text-#303030 text-base sm:text-lg leading-[160%]">
          3.
          <span className="relative before:absolute before:bg-[#303030] before:h-[1px] before:w-full before:left-[1%] before:content-[''] before:bottom-[2px]"> Why you don’t need more than 3 pieces of clothing</span>

        </p>
      </div>
      <p className="ff_roboto text-lg sm:text-xl text-[#434343] leading-[160%]">
