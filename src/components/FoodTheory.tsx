...
const FoodTheory = () => {
  return (
    <div className="container xl:max-w-[800px] 3xl:max-w-[1140px] mx-auto px-3 xl:px-0 pt-14 sm:pt-[93px]">
      ...
      <img
        className="w-full min-h-[200px] sm:min-h-[268px]"
        height={268}
        width={800}
        src={blog_Nature_img}
        alt="nature"
      ...
      <div className="bg-[#F5F5F5] px-5 py-5 sm:px-9 sm:py-8 rounded-[7px]">
        ...
        <span className="relative z-0 before:absolute before:bg-[#303030] before:h-[1px] before:w-full before:left-[1%] before:content-[''] before:bottom-[2px]"> How to travel without spending a dime</span>

        </p>
        <p className="ff_Merriweather text-#303030 text-base sm:text-lg leading-[160%] py-4">
          2. 
          <span className="relative z-0 before:absolute before:bg-[#303030] before:h-[1px] before:w-full before:left-[1%] before:content-[''] before:bottom-[2px] my-4"> Get the most out of your credit card reward points</span>

        </p>
        <p className="ff_Merriweather text-#303030 text-base sm:text-lg leading-[160%]">
          3.
          <span className="relative z-0 before:absolute before:bg-[#303030] before:h-[1px] before:w-full before:left-[1%] before:content-[''] before:bottom-[2px]"> Why you don’t need more than 3 pieces of clothing</span>
